...
def fetch_articles(article_ids, xml_saved=False, xml_path="../_data_/", csv_saved=True, csv_path="../data/"):
    ...
    articles = list([_fetch_article(
        batech_ids=batch) for batch in _batches(article_ids, 250)]
        )
